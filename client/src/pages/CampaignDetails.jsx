...
const CampaignDetails = () => {
  ...
  // state returns the whole Campaign itself, as mentioned in DisplayCampaigns
    ...
    <div>
      ...
      <div className='mt-[60px] flex lg:flex-row flex-col gap-5'>
        <div className='flex-[2] flex flex-col gap-[40px]'>
            ...
            <div className='mt-[20px] flex flex-row items-center flex-wrap gap-[14px]'>
              ...
              */}
              <div className='w-[52px] h-[52px] flex justify-center items-center rounded-full bg-[#2c2f32] cursor-pointer'>
                  <img className='w-[60%] h-[60%] object-contain' src={thirdweb} alt='user'/>
              </div>
              <div>
          ...
          <div>
            ...
            <div className='mt-[20px]'>
              {/* Displaying the Story of each campaign */}
          ...
          <div>
            ...
            <div className='mt-[20px] flex flex-col gap-4'>
              ...
              {/* Fetching No.of donators to a certain campaign */}
              {donators.length > 0 ? donators.map((item, index) => (
                <div key={`${item.donator}-${index}`} className="flex justify-between items-center gap-4">

                  {/* Donator's address and the amount donated */}
        ...
        <div className='flex-1'>
          ...
          <div className='mt-[20px] flex flex-col p-4 bg-[#0F3460] rounded-[10px]'>
